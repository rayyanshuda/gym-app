  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
        ...
        <h2 className="capitalize whitespace-nowrap truncate nax-w-full text-log sm:text-xl md:text-2xl flex-1 sm:text-center">
      ...
      <div className="flex flex-col bg-slate-950 rounded gap-2 py-4">
